...
// import * as slcomp from '@shoelace-style/shoelace/dist/shoelace.js';
import { layoutData, pageTree } from '#src/layouts/layoutData.js';
import {ChildListMenu, Layout} from '@rocket/engine';
...
// 154: <h1>${pageTree.getPage(data.sourceRelativeFilePath)?.model?.name}</h1>
...
export const openGraphLayout = data => html`
  ...
  <html lang="en">
    ...
    <body>
      ...
      <div>${pageTree.renderMenu(new ChildListMenu(), data.sourceRelativeFilePath)}</div>
