...
import { html, dsMenu, setupUnifiedPlugins, components, openGraphLayout } from '../recursive.data.js';
export { html, dsMenu, setupUnifiedPlugins, components, openGraphLayout };
